-- Migracion: 019_rewrite_branch_control_report_avoid_output_conflicts
-- Corrige error 42702 en branch_control_report.
-- Causa: conflicto entre nombres de columnas de retorno de RETURNS TABLE
--        y referencias internas dentro de PL/pgSQL.
-- Ejecutar despues de 018_fix_branch_control_report_active_ambiguity.sql.
