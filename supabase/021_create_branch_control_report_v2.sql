-- Migracion: 021_create_branch_control_report_v2
-- Objetivo: crear una RPC nueva para evitar la ruta cacheada de branch_control_report.
-- Causa: PostgREST sigue respondiendo con error 42702 desde /rpc/branch_control_report.
-- Ejecutar despues de 020_force_recreate_branch_control_report_rpc.sql.

create or replace function public.branch_control_report_v2(p_from timestamptz,p_to timestamptz)
returns table(
